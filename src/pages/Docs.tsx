...
export default function Docs() {
          ...
          <div className="lg:col-span-3 space-y-16">
            ...
            <section id="base-url" className="p-6 bg-dark-card border border-white/10 rounded-2xl">
              ...
              <div className="flex items-center justify-between bg-black/40 p-4 rounded-xl border border-white/5 group">
                <code className="text-neon-cyan font-mono text-sm break-all">https://api.aifeastengine.com/api</code>
                <button onClick={() => copyToClipboard("https://api.aifeastengine.com/api")} className="p-2 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div className="space-y-4">
                <div className="bg-dark-card border border-white/10 rounded-2xl overflow-hidden">
                  <div className="bg-white/5 px-4 py-2 flex items-center justify-between border-b border-white/5">
                    ...
                    <button onClick={() => copyToClipboard("curl -H 'X-API-Key: YOUR_KEY' https://api.aifeastengine.com/api/feed?lang=en")} className="text-xs text-neon-cyan hover:underline">Copy</button>
                  </div>
                  <pre className="p-6 text-xs font-mono text-gray-300 overflow-x-auto bg-black/20">
                    {`curl -X GET "https://api.aifeastengine.com/api/feed?lang=en" \\
  -H "X-API-Key: YOUR_API_KEY"`}
                ...
                <div className="bg-dark-card border border-white/10 rounded-2xl overflow-hidden">
                  ...
                  <pre className="p-6 text-xs font-mono text-gray-300 overflow-x-auto bg-black/20">
                    {`const response = await fetch('https://api.aifeastengine.com/api/feed?lang=pt', {
  headers: {
...
url = "https://api.aifeastengine.com/api/feed"
